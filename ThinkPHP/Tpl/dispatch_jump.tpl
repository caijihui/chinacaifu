...
{literal}
*{ padding: 0; margin: 0; }
body{ background: #fff; font-family: '微软雅黑'; color: #333; font-size: 16px; background: url(/Public/Images/dis_jump1.jpg); }
.clearfix{*zoom:1;}
.clearfix:after{display: block;content: " ";height:0;visibility:hidden;clear: both;}
.fl{float: left;}
.fr{float: right;}
.msgbox{ width: 652px;  height: 293px; margin: 0 auto; margin-top: 100px; padding-top: 107px; background: url(/Public/Images/dis_jump2.png) no-repeat;}
...
<body>
	<div class="msgbox">
		<div class="msgbox-info clearfix">
				<empty name="error">
				<span class="emo fl"><img src="/Public/Images/dis_jump4.png"></span>
				<span class="success fl">{$message}</span>
				</empty>
				<empty name="message">
				<span class="emo fl"><img src="/Public/Images/dis_jump3.png"></span>
